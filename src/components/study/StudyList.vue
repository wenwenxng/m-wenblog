    ...
    export default {
        ...
        methods:{
            initStudyList(callback){
                this.pageIndex=1
                this.$axios.get('/api/article/queryArticle.php?art_type_id=1,2&pageSize=5&page=' + this.pageIndex)
                    .then((res) => {
            ...
            getMoreStudyList(callback){
                this.pageIndex++
                this.$axios.get('/api/article/queryArticle.php?art_type_id=1,2&pageSize='+this.pageSize+'&page=' + this.pageIndex)
                    .then((res) => {
